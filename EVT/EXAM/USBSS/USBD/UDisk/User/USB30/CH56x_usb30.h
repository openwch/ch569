...
extern __attribute__ ((aligned(16))) UINT8	endp1RTbuff[MAX_BUF_BLOCK*512] __attribute__((section(".DMADATA")));
extern __attribute__ ((aligned(16))) UINT8	endp2RTbuff[MAX_BUF_BLOCK*512] __attribute__((section(".DMADATA")));
